...
import PasswordInput from '@/app/components/ui/form/Password';
import FormError from '@/app/components/ui/form/formError';
import Form from '@/app/components/ui/form/Form';
import Button from '@/app/components/ui/button/Button';
import { useUser } from '@/app/contexts/UserContext';
import { notifySuccess, notifyError } from '@/app/components/ui/Toastify';
...
function LoginForm() {
    ...
    return (
        <Form autoComplete="on" onSubmit={handleSignIn}>
            {showLoginForm && !showResetPasswordForm && !showForgetPasswordForm && (
                <Stack animationType={backButtonClicked ? "animateMoveFromLeft" : "animateFadeIn"} direction="column">
                    ...
                    <Button width="full-width" variant="primary" disable={disable} onClick={handleSignIn} type="submit">Se connecter</Button>
                    <Stack justify="end">
